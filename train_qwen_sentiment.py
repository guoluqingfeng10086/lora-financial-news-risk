...
def create_model_and_tokenizer():
    ...
    model_name = "/data1/wz25/Finance/Qwen"
    ...
    # 梯度设置
    model.enable_input_require_grads()  # 解决 "does not require grad" 报错
    model.config.use_cache = False      # 显式关闭缓存，配合梯度检查点
...
def main():
    """主函数"""
    # 数据路径
    csv_path = "/data1/wz25/Finance/nasdaq_news_sentiment/sentiment_deepseek_new_cleaned_nasdaq_news_full.csv"

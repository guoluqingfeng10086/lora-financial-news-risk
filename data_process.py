...
class NewsDeduplicator:
    ...
    def load_and_preprocess_data(self, csv_file_path: str = "/data1/wz25/Finance/risk_nasdaq/2.csv"):
        """从本地CSV文件加载并预处理数据"""
        print("正在加载CSV文件...")
    ...
    def process_dataset(self, csv_file_path: str = "/data1/wz25/Finance/risk_nasdaq/2.csv", 
...
if __name__ == "__main__":
    ...
    try:
        unique_news = deduplicator.process_dataset(
            csv_file_path="/data1/wz25/Finance/risk_nasdaq/risk_deepseek_cleaned_nasdaq_news_full.csv", #  替换为你的路径

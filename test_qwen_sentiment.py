...
def load_trained_sentiment_model(model_path="/data1/wz25/Finance/qwen_sentiment_modell"):
    """加载训练好的情感分析模型"""
...
def test_sentiment_model():
    ...
    print("\n=== 真实数据测试 ===")
    try:
        df = pd.read_csv("/data1/wz25/Finance/nasdaq_news_sentiment/1.csv", nrows=10)
